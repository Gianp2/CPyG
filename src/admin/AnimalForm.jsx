        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, tamaño: e.target.value })
              }
            >
          ...
          <div className="space-y-2">
            ...
            <div
              className={`${inputClasses} bg-brand-primary/10 text-brand-primary font-black flex items-center`}
            >
              🐾 En adopción
            </div>
          </div>
      ...
      {showCropper && preview && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-6">
          <div className="bg-white rounded-3xl p-6 w-full max-w-2xl">
            <h2 className="font-bold text-xl mb-4">Recortar imagen</h2>
            ...
            <div className="flex gap-3 mt-6">
              <button
                type="button"
                onClick={applyCrop}
                className="flex-1 bg-green-600 hover:bg-green-700 text-white py-3.5 rounded-2xl font-bold transition-colors"
              >
                Aplicar Recorte
              </button>
              <button
                ...
                className="flex-1 bg-slate-200 hover:bg-slate-300 py-3.5 rounded-2xl font-bold transition-colors"
              >
                Cancelar
              </button>
            </div>
